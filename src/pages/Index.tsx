...
const Index: React.FC = () => {
  ...
  useEffect(() => {
    ...
    imagePromptParts.push(
      'Professional technical catalog lighting, solid neutral grey background, isometric view, 8k resolution, photorealistic industrial render. NO factory background, NO robots, NO people.',
    )
    ...
    <div style={{ padding: '20px', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ display: 'grid', gap: '15px', marginBottom: '30px' }}>
        ...
        <div>
          ...
          <select
            name="metodo_construcao"
            value={formData.metodo_construcao}
        ...
        <div>
          ...
          <input
            type="text"
            name="dimensoes_externas"
            value={formData.dimensoes_externas}
            onChange={handleChange}
          />
        </div>
        <div>
      ...
      <div style={{ backgroundColor: '#f0f0f0', padding: '15px', borderRadius: '8px' }}>
        ...
        <p>
          <strong>[ANÁLISE DO ENGENHEIRO DE VENDAS D-LEAN]</strong>
        </p>
        <p>
          <em>System Prompt: "{consultorPrompt}"</em>
        </p>
        <p>
          Equipamento: {formData.equipamento} ({formData.metodo_construcao})
        </p>
        <p>
          Dimensões: {formData.dimensoes_externas} | Carga Solicitada: {formData.carga}kg
        </p>
        <p>
          <strong>Status:</strong> Análise técnica em tempo real baseada nos dados do formulário.
        </p>
      </div>
